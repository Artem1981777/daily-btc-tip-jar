...
const MOCK_TIPS = [
  { sender: "tb1pqm34a...gkzm", amount: 1000, time: "Mar 9, 22:00" },
  { sender: "tb1p8jdlf...5ecp", amount: 546,  time: "Mar 9, 21:30" },
  { sender: "tb1pxhm8x...9yze", amount: 5000, time: "Mar 9, 20:15" },
  { sender: "tb1prt5k4...3pvz", amount: 2000, time: "Mar 9, 19:45" },
  { sender: "tb1p6e3k2...5xjq", amount: 750,  time: "Mar 9, 18:00" },
];
...
export default function App() {
  ...
  const [seconds, setSeconds] = useState(3600 * 5);
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.1fr", gap: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
          ...
          <div style={{ background: "#0a0f1e", border: "1px solid rgba(0,212,255,0.15)", borderRadius: "4px", padding: "1.4rem" }}>
            ...
            {status === "success" && <p style={{ fontSize: "0.85rem", color: "#00ff9f", textAlign: "center", marginTop: "0.6rem" }}>⚡ Lightning strike! Tip confirmed.</p>}
          </div>
        </div>
        ...
        <div style={{ background: "#0a0f1e", border: "1px solid rgba(0,212,255,0.15)", borderRadius: "4px", padding: "1.4rem" }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem" }}>
            ...
            <span style={{ color: "#4a6080", fontSize: "0.68rem" }}>{MOCK_TIPS.length} entries</span>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
            {MOCK_TIPS.map((tip, i) => (
              <div key={i} style={{
                ...
                borderLeft: "2px solid transparent", fontSize: "0.72rem"
              }}>
      ...
      <div style={{ textAlign: "center", marginTop: "2rem", fontSize: "0.65rem", color: "#4a6080", borderTop: "1px solid rgba(0,212,255,0.1)", paddingTop: "1rem" }}>
        Built on OPNet · Quantum-safe ML-DSA · Testnet only
      </div>
